...
- Изучить среднюю цену квадратного метра в десяти населенных пунктах с наибольшим количеством объявлений.
- Изучить влияние расстояния до центра на среднюю стоимость квадратного метра для Санкт-Петербурга.
